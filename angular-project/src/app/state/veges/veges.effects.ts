...
//import { VegeService } from "src/app/shared/vegeService";
import { VegeService } from 'src/shared/vegeService';
import * as ProductActions from './veges.action'

@Injectable()
export class ProductEffects {

  constructor(private actions$: Actions, private productService: VegeService) { }
